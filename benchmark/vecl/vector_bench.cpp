...
BENCHMARK_TEMPLATE(DefaultConstruct, std::vector<int>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(DefaultConstruct, vecl::small_vector<int, 16>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(DefaultConstruct, vecl::fixed_vector<int, MAX_SIZE>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
...
BENCHMARK_TEMPLATE(ConstructWithSize, std::vector<std::string>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(ConstructWithSize, vecl::small_vector<std::string, 16>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(ConstructWithSize, vecl::fixed_vector<std::string, MAX_SIZE>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
...
BENCHMARK_TEMPLATE(EmplaceBack, std::vector<int>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(EmplaceBack, vecl::small_vector<int, 16>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(EmplaceBack, vecl::fixed_vector<int, MAX_SIZE>)->RangeMultiplier(4)->Range(8, MAX_SIZE);

BENCHMARK_TEMPLATE(EmplaceBackReserve, std::vector<int>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(EmplaceBackReserve, vecl::small_vector<int, 16>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(EmplaceBackReserve, vecl::fixed_vector<int, MAX_SIZE>)->RangeMultiplier(4)->Range(8, MAX_SIZE);

BENCHMARK_TEMPLATE(EmplaceBackReserve, std::vector<std::string>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(EmplaceBackReserve, vecl::small_vector<std::string, 4>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(EmplaceBackReserve, vecl::fixed_vector<std::string, MAX_SIZE>)->RangeMultiplier(4)->Range(8, MAX_SIZE);

BENCHMARK_TEMPLATE(RandomSortedInsertion, std::vector<size_t>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(RandomSortedInsertion, vecl::small_vector<size_t, 8>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
BENCHMARK_TEMPLATE(RandomSortedInsertion, vecl::fixed_vector<size_t, MAX_SIZE * 2>)->RangeMultiplier(4)->Range(8, MAX_SIZE);
